...
import es.outlook.adriansrj.battleroyale.loot.LootConfigurationEntry;
 ...
 */
public final class BattleRoyaleLootConfigHandler extends ConfigurationHandler {
	 ...
	 */
	public BattleRoyaleLootConfigHandler ( BattleRoyale plugin ) {
		super ( plugin );
	}
