 ...
 */
class SetPlayerSpawnsButton extends SetupToolButtonBase {
	
	public SetPlayerSpawnsButton ( ) {
		super ( ChatColor.GOLD + "Set Player Spawns" , UniversalMaterial.WHITE_BED.getItemStack ( ) ,
				"" ,
