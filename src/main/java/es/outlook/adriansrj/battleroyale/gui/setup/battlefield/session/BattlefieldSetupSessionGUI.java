	...
	private synchronized void build ( Player player ) {
		...
		if ( session != null ) {
			...
			if ( session.isNameSet ( ) && session.isBoundsSet ( ) ) {
				...
				//							}
				//
				//							action.getPlayer ( ).sendMessage ( ChatColor.GOLD + "World saved successfully." );
				//							action.getPlayer ( ).sendMessage ( ChatColor.GOLD + "* Updating minimap..." );
				//							action.getPlayer ( ).sendMessage ( ChatColor.GOLD + "* Updating schematic..." );
				//
				...
				//										if ( minimap != null ) {
				//											action.getPlayer ( ).sendMessage (
				//													ChatColor.GREEN + "Minimap updated successfully!" );
				//										} else {
				//											action.getPlayer ( ).sendMessage (
				//													ChatColor.DARK_RED + "Something went wrong when
				//													recalculating" +
				...
				//										if ( successful ) {
				//											action.getPlayer ( ).sendMessage (
				//													ChatColor.GREEN + "Schematic updated successfully!" );
				//										} else {
				//											action.getPlayer ( ).sendMessage (
				//													ChatColor.DARK_RED + "Something went wrong when saving
				//													changes." +
