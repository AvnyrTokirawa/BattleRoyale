 ...
 */
class PacketFactoryServiceHandle_v1_9_R2 implements PacketFactoryServiceHandle {
	
	public PacketFactoryServiceHandle_v1_9_R2 ( ) {
	...
	public Object createEntityRelativeMovePacket ( int entity_id , int delta_x , int delta_y , int delta_z ,
			boolean on_ground ) {
		return new PacketPlayOutEntity.PacketPlayOutRelEntityMove ( entity_id , delta_x , delta_y , delta_z , on_ground );
	}
