 ...
 */
class PacketSenderServiceHandle_v1_16_R2 extends PacketSenderServiceHandleBase {
	...
	public PacketSenderServiceHandle_v1_16_R2 ( ) {
	...
	public void sendSpawnEntityPacket ( Player player , org.bukkit.entity.Entity entity ) {
		...
		Packet < ? >           packet  = handle.P ( ); // spawn packet
