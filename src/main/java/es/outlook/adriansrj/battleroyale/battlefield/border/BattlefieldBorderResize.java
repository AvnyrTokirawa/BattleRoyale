...
public class BattlefieldBorderResize implements Configurable {
	...
	public BattlefieldBorderResize ( Location2D location , double radius , double damage ,
	...
	public BattlefieldBorderResize ( Vector location , double radius , double damage ,
			Duration time , Duration idle_time ) {
	...
	@Override
	public BattlefieldBorderResize load ( ConfigurationSection section ) {
		loadEntries ( section );
		return this;
	}
	...
	public boolean equals ( Object o ) {
		...
		BattlefieldBorderResize that = ( BattlefieldBorderResize ) o;
		return Double.compare ( that.radius , radius ) == 0
				&& Double.compare ( that.damage , damage ) == 0 && Objects.equals (
